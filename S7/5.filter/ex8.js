...
// que incluyan la palabra introducida en el input. De esta forma, 
// si introduzco 'Ru' me deberia de mostrar solo el streamer 'Rubius'. 
...
const tofilter = (input) => {
    let streamersFiltrados = streamers.filter(streamer => streamer.name.toLowerCase().includes(input$$.value))
...
boton$$.addEventListener("click",tofilter)