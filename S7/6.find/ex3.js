...
// y la mutación 'Porompompero'. Una vez que los encuentres, usa spread operator para fusionarlos 
...
const mutacionEncontrada = mutations.find(mutation => mutation.name === "Porompompero" )

const fusion = {...alienEncontrado, mutation: {...mutacionEncontrada}}
